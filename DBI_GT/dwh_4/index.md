---
title: DWH 4 Create Table
layout: report
date: 2017-02-04
taskHref: http://griesmayer.com/?menu=Dataware%20House&semester=Semester_5&topic=04_Create%20Table
subject: dbi
---
...
```bash
#!/bin/bash
sqlplus schreib_explain/oracle @Desktop/products_schreib.plsql &
sqlplus schreib_explain/oracle @Desktop/producs_schreib.sql
